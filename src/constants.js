export default {
  cultivatrBlurb: `CultivatR is an online market where Albertans can buy fresh product 
  ...
  julesMarketBlurb: `Jules market is an online clothing store. Users browse items by category
                , or by gender. Items can be added to, and removed from, a shopping cart. The App is integrated with the Stripe API
                to simulate payments`,
  julesMarketTech: `Jules Market is built with React.js. styling is done with SCSS. It uses Redux for state management. The App is integrated wtith Google Firebase.
                Firebase is used for handling user authenthication and session management. It is also used to store the Apps data`,
  about: `I have a B.Sc. in Electrical Engineering from the University of Calgary, and a Web Developer Certificate from EvolveU.
